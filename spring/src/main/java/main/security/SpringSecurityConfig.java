...
public class SpringSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.httpBasic().disable()
                ...
                .antMatchers(HttpMethod.GET, "/bt/marks/{id}").hasRole ("USER")
                .antMatchers(HttpMethod.GET, "/bt/people/{id}").hasRole ("USER")
                .antMatchers(HttpMethod.GET, "/bt/subjects/{id}").hasRole ("USER")
                .antMatchers(HttpMethod.GET, "/bt/groups/{id}").hasRole ("USER")
                ...
                .antMatchers(HttpMethod.POST, "/bt/deleteMarks/{id}").hasRole("ADMIN")
                .antMatchers(HttpMethod.POST, "/bt/deletePeople/{id}").hasRole("ADMIN")
                .antMatchers(HttpMethod.POST, "/bt/deleteSubjects/{id}").hasRole("ADMIN")
                .antMatchers(HttpMethod.POST, "/bt/deleteGroups/{id}").hasRole("ADMIN")
